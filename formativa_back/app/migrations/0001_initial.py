# Generated by Django 5.1.7 on 2025-06-23 12:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nome', models.CharField(help_text='Nome da disciplina.', max_length=100, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('curso', models.CharField(help_text='Curso associado à sala.', max_length=100)),
                ('descricao', models.TextField(blank=True, help_text='Descrição da sala.', null=True)),
                ('capacidade', models.PositiveIntegerField(help_text='Capacidade máxima da sala.')),
                ('periodo', models.CharField(choices=[('MANHA', 'Manhã'), ('TARDE', 'Tarde'), ('NOITE', 'Noite')], help_text='Período em que a sala está disponível.', max_length=5)),
                ('professor', models.ForeignKey(help_text='Professor responsável pela sala, se aplicável.', limit_choices_to={'tipo': 'PROFESSOR'}, on_delete=django.db.models.deletion.CASCADE, related_name='salas', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Sala',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('disciplina', models.ForeignKey(help_text='Disciplina associada à reserva.', on_delete=django.db.models.deletion.CASCADE, related_name='reservas', to='app.disciplina')),
                ('professor', models.ForeignKey(help_text='Professor responsável pela reserva.', limit_choices_to={'tipo': 'PROFESSOR'}, on_delete=django.db.models.deletion.CASCADE, related_name='reservas', to=settings.AUTH_USER_MODEL)),
